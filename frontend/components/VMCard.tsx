...
// Ubicación: gcp-vm-dashboard/frontend/components/VMCard.tsx

import React from 'react';
import { VirtualMachine, VMStatus } from '../types'; // Importación relativa
import { PowerIcon, StopIcon, LinkIcon, ChipIcon, LocationMarkerIcon, ClipboardCopyIcon, CogIcon } from './icons'; 
// Asegúrate de que tus iconos de CPU y RAM están en icons.tsx o los defines aquí.
// Aquí he puesto SVG genéricos directamente como ejemplo.
    ...
    >
      ...
      <div className="p-5 space-y-3 text-sm text-gray-600 flex-grow">
        ...
        <div className="flex items-center">
          ...
          <span>Tipo de máquina: {vm.machineType}</span>
        </div>
      </div>
