...
export const CloudIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15a4.5 4.5 0 0 0 4.5 4.5h8.25a4.5 4.5 0 0 0 4.5-4.5V8.25a4.5 4.5 0 0 0-4.5-4.5h-1.5a4.5 4.5 0 0 0-4.5-4.5H8.25a4.5 4.5 0 0 0-4.5 4.5v6.75Z" />
  </svg>
);
...
// --- ICONOS USADOS EN LA LISTA Y MODALES ---
...
export const CogIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-.962a8.25 8.25 0 0 1 5.962 5.962c.045.552-.421 1.02-.962 1.11l-.542.09c-.552.045-1.02.421-1.11.962a8.25 8.25 0 0 0-5.962 5.962c-.045.552.421 1.02.962 1.11l.542.09c.552.045 1.02.421 1.11.962a8.25 8.25 0 0 1-5.962 5.962c-.552.045-1.02-.421-.962-1.11l-.09-.542c-.045-.552-.421-1.02-.962-1.11a8.25 8.25 0 0 1-5.962-5.962c-.045-.552.421-1.02.962-1.11l.09-.542c.045-.552.421-1.02.962-1.11a8.25 8.25 0 0 1 5.962-5.962l.542-.09c.552-.045 1.02-.421 1.11-.962Z" />
